...
const ShippingDetails = ({
  ...
  return (
    <div className="text-base-regular">
      <h2 className="text-base-semi">Transport</h2>
      <div className="my-2">
        <h3 className="text-small-regular text-gray-700">Aadress</h3>
      ...
      <div className="my-2">
        <h3 className="text-small-regular text-gray-700 xsf:font-bold xsf:mb-2 xsf: mt-2">Kohaletoimetamise viis:</h3>
        <div>
