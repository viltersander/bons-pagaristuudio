...
const ContactsPage: React.FC = () => {
  ...
  return (
    <div id="contact" style={{ position: 'relative', height: '400px' }}>
      ...
      />
      <div className="absolute top-10 left-8 bg-white p-4 shadow-xl border-2 border-black rounded-lg">
        <h2>Böns Pagaristuudio</h2>
        <p>Kohtu 1a, Kuressaare, Estonia</p>
        <p>Tel 5335 8141</p>
        <p>bonspagar@gmail.com</p>
      </div>
      <div className="absolute top-16 right-8 bg-white p-4 shadow-xl border-2 border-black rounded-lg">
        <h2>Avatud</h2>
